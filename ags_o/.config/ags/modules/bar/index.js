...
import batteryIndicator from "../battery/index.js";
    ...
    child: Widget.Box({
      children: [
        ...
        Widget.EventBox({
          ...
          child: Widget.Box({
            children: [batteryIndicator, NotificationIndicator(), Clock()],
          }),
        }),
      ],
    }),
...
const BarWindow = (/** @type {number} */ monitor) =>
  Widget.Window({
    monitor,
    name: `bar${monitor}`,
